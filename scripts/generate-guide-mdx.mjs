...
const guides = [
  {
    ...
    description:
      "A guide on accessing the WesterosCraft server using the MultiMC Launcher.",
    guideCategory: {
      title: "Getting Started",
    },
    icon: {
      ...
      },
      {
        ...
        images: [
          ...
          },
          {
            ...
            description:
              "A mixture of large oaks, willows, and chestnuts. Good for forests",
            heading: "BroadleafL",
            title: "BroadleafL",
          },
          {
            ...
            description:
              "A mixture of ForestMaple, ForestOak, CottonwoodM, ForestMaple",
          ...
          },
          {
            ...
            description:
              "A mixture of AspenM, BeechM, HawthornS,BeechS, OakS, OakM, OakL",
            heading: "LeafyForest",
            title: "LeafyForest",
          },
          {
            ...
            description:
              "A mixture of OakM, AshM, BMapleM, CottonwoodM, AlderM",
          ...
          },
          {
            ...
            description:
              "Mixture of medium trees, for northern forests (oak and spruce trunks)",
            heading: "WolfswoodM",
            title: "WolfswoodM",
          },
          {
            ...
            description:
              "Mixture of small trees, for northern forests (spruce and jungle trunks)",
            heading: "WolfswoodS",
            title: "WolfswoodS",
          },
          {
            ...
            description:
              "Mixture of extra large trees, for northern forests (deep forest only!)",
            heading: "WolfswoodXL",
            title: "WolfswoodXL",
          },
        ],
      ...
      },
      {
        ...
        images: [
          ...
          },
          {
            ...
            alt: "",
            description:
              "Clusters of bracken, to be used on its own or to create larger patches",
            heading: "Bracken",
            title: "Bracken",
          },
          {
            ...
            description:
              "Clusters of water vegetation. Place 1 lower than eventual water level",
            heading: "BWater",
            title: "BWater",
          },
          {
            ...
            description:
              "Small bushes, rocks, and clusters of flowers for meadows",
            heading: "CarcMeadow",
            title: "CarcMeadow",
          },
          {
          ...
          },
          {
            ...
            description:
              "Clusters of cow parsley, to be used on its own mostly",
            heading: "CowParsley",
            title: "CowParsley",
          },
          {
          ...
          },
          {
            ...
            description:
              "Clusters of ferns, to be used on its own or to create larger patches",
          ...
          },
          {
            ...
            description:
              "Clusters of grass, to be used on its own or to create larger patches",
          ...
          },
          {
            ...
            description:
              "Clusters of nettles, to be used on its own or to create larger patches",
            heading: "Nettles",
            title: "Nettles",
          },
          {
  ...
  },
  {
    _createdAt: "2021-01-23T19:14:23Z",
    _id: "server-rules",
    _rev: "KpIbB054A2BCl0nlJZDLLc",
    _type: "guide",
    _updatedAt: "2022-09-14T00:38:57Z",
    body: [
      {
        _key: "39aa4f1cdf08",
        _type: "block",
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            _type: "span",
            marks: [],
            text: " with the community. Check the forums regularly in case anyone is trying to reach out to you! As a builder, if you have been absent for more than three months you may be asked to reapply for builder status.",
          },
        ],
        markDefs: [],
        style: "normal",
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            _type: "span",
            marks: [],
            text: ". Press F1 to hide chat if you want to avoid spoilers. Intentionally spoiling someones experience is a ban worthy offense.",
          },
        ],
        markDefs: [],
        style: "normal",
    ...
    guides.forEach((guide) => {
      if (guide.guideCategory.title === folder.title) {
        const getStringToRender = () => {
          ...
          const importCallout = guide.body?.some((x) => x._type === "callout")
            ? `import { Callout } from 'nextra-theme-docs';\n\n`
            : undefined;
          stringToRender.push(importCallout);

          const convertedBody = toMarkdown(guide.body, { serializers });
        ...
        fs.writeFileSync(
          `./pages/guides/${folder.path}/${guide.slug.current}.mdx`,
          getStringToRender()
        );
      }
    })
