...
**If you are considering redoing, updating, or fostering an old project, please consult the [Official No-Redo Rule](https://westeroscraft.com/wiki/guides/official-no-redo-rule) and [Projects Orphanage](https://westeroscraft.com/wiki/guides/projects-orphanage). Currently each of these project types is defined as:  
...
Please advertise available plots  and Mini Builds using [marker signs](https://forum.westeroscraft.com/threads/marker-signs.2405/) and by posting in your project application thread. Builders can take on Mini Builds by applying for them in the project thread and must be approved in writing by the project leader and one of the approving moderators before it can begin.   
...
**Final Checks**  
Once your Canon Project application has been approved, you are required to finish the project to 100% completion including all Mini Builds and terraforming as well as a [Wiki Submission](https://forum.westeroscraft.com/form/wiki-article-submission-form.6/select). It is your responsibility to see that all areas of your project are completed and finished to an acceptable standard, including those areas delegated to others. 
