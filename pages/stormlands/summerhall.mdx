...
<Image src="https://cdn.sanity.io/images/1as7cn02/production/90758b356d2c321358c3888716853624b53a68d7-1280x720.png?w=976&h=350&fit=crop&crop=center&auto=format" alt="Summerhall" width={976} height={350}  />
...
<ProjectDetails
  ...
  dateStarted="March 3, 2019"
  dateCompleted="March 3, 2019"
/>

_“After unifying Dorne into the Seven Kingdoms, King Daeron II raised a great seat in the Dornish Marches, near to where the boundaries of the Reach, the Stormlands, and Dorne met. Calling it Summerhall to mark the peace he had created, it was more palace than castle and lightly fortified at best; in the years to come, many sons of House Targaryen would hold the seat as Prince of Summerhall.”_  


**Summerhall **is a ruined Targaryen castle located in the Dornish Marches region of the [Stormlands](https://westeroscraft.com/wiki/stormlands).
...
Summerhall also features an abandoned castle town, unofficially dubbed Summertown. The town was designed with the view that it was built to cater to the royal court and its substantial demand for resources and luxuries. In much the same way [King's Landing](https://westeroscraft.com/wiki/crownlands/kings-landing) grew around the Aegon Fort (and subsequent [Red Keep](https://westeroscraft.com/wiki/crownlands/red-keep)), so too did the town grow around Summerhall.

While Summerhall stood, Summertown thrived. Following the Tragedy though, the town may have tried to persevere, but without the demand for produce from the palace or the protection of the royal guard, much of the town’s people chose to leave for the nearby towns of [Blackhaven](https://westeroscraft.com/wiki/stormlands/blackhaven) and [Gallowsgrey](https://westeroscraft.com/wiki/stormlands/gallowsgrey). The rumors of vengeful Targaryen spirits haunting Summerhall, and the growing threat of looters and bandits picking over the palace’s remains only spurred the exodus.
